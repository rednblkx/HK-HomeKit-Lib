...
namespace jsoncons
{
  ...
  {
    static inline const char* reader_sk_str(char) { return "reader_private_key"; }
    static inline const wchar_t* reader_sk_str(wchar_t) { return L"reader_private_key"; }
    static inline const char* reader_public_key_str(char) { return "reader_public_key"; }
    static inline const wchar_t* reader_public_key_str(wchar_t) { return L"reader_public_key"; }
    static inline const char* reader_pk_x_str(char) { return "reader_key_x"; }
    static inline const wchar_t* reader_pk_x_str(wchar_t) { return L"reader_key_x"; }
    static inline const char* reader_gid_str(char) { return "group_identifier"; }
    static inline const wchar_t* reader_gid_str(wchar_t) { return L"group_identifier"; }
    static inline const char* identifier_str(char) { return "unique_identifier"; }
    static inline const wchar_t* identifier_str(wchar_t) { return L"unique_identifier"; }
